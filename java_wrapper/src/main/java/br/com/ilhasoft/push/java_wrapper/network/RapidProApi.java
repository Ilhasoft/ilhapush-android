...
import br.com.ilhasoft.push.java_wrapper.models.Boundary;
...
import br.com.ilhasoft.push.java_wrapper.models.FlowStepSet;
import br.com.ilhasoft.push.java_wrapper.models.Group;
...
public interface RapidProApi {
    ...
    Call<br.com.ilhasoft.push.java_wrapper.models.Field> listFields(@Header("Authorization") String token);
